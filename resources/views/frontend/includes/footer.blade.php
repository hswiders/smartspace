...
@endphp
<footer class="footer-area style-two" style="background: url('{{asset('assets/frontend/images/footer-banner.jpg')}}') no-repeat center/cover;">
                    ...
                    <div class="col-lg-4 col-md-9">
                        ...
                        <div class="widget widget_about widget-tags pt-2">
                            ...
                            <div class="details">
                                ...
                                <p><i class="fas fa-phone-volume"></i> {{ $contact_info->phone }} </p>
                                <p><i class="fas fa-envelope"></i> {{ $contact_info->email }} </p>
                            </div>
                            <ul class="social-area">
                                <li><a href="{{ $social_links->facebook }}"><i class="fab fa-facebook-f" aria-hidden="true"></i></a></li>
                                <li><a href="{{ $social_links->youtube }}"><i class="fab fa-youtube" aria-hidden="true"></i></a></li>
                                <li><a href="{{ $social_links->instagram }}"><i class="fab fa-instagram" aria-hidden="true"></i></a></li>
                            </ul>
...
function timers() {
  ...
  tmrAjax = setInterval(function () {
    $.ajax({
          url:"{{ route('user.update-activity') }}",
          method:"POST",
