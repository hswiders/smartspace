...
<div class="add-property-area pd-top-120 body-bg">
    <div class="container">
          ...
          <form class="" method="post" id="handleAjax" action="{{route('user.property.update')}}" name="postform">
            <div class="row">
               <div class="col-12">
                        ...
                        <label class="single-input-inner style-bg-border">
                            ...
                            <select name="property_category" class="form-control">
                                ...
                                @forelse ($categories as $element)
                                    <option {{ ($property->property_category == $element->id) ? 'selected' : '' }} value="{{$element->id}}">{{$element->title}}</option>
                                @empty
                    ...
                    <div class="col-md-6">
                        <div class="single-select-inner style-bg-border">
                            ...
                            <select name="bedrooms" class="form-control">
                                ...
                                <option {{ ($property->bedrooms == 1) ? 'selected' : '' }} value="1">1 Bedroom</option>
                                <option {{ ($property->bedrooms == 2) ? 'selected' : '' }} value="2">2 Bedroom</option>
                                <option {{ ($property->bedrooms == 3) ? 'selected' : '' }} value="3">3 Bedroom</option>
                                <option {{ ($property->bedrooms == 4) ? 'selected' : '' }} value="4">4 Bedroom</option>
                                <option {{ ($property->bedrooms == 5) ? 'selected' : '' }} value="5">5 Bedroom</option>
                        ...
                        <ul class="my_list">
                            @forelse ($parking_types as $element)
                                <li class="single-select-inner style-bg-border">
                                    ...
                                    @endphp
                                <label><input {{ (in_array($element->id, $parking_type)) ? ' checked' : '' }} type="checkbox" name="parking_type[]" class="checkbox" value="{{$element->id}}"> {{ $element->title }} </label>
                            </li>
                            @empty
...
$(document).ready(function() {
    UpdateLocation('{{$property->lat}}' , '{{$property->lng}}')
});
</script>
<style>
        #myMap {
