<?php echo $__env->make('frontend.includes.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <div class="banner-area banner-area-2 banner-area-bg" style="background: url('<?php echo e(asset('public/assets/frontend/images/banner-main.jpg')); ?>'); background-attachment: fixed;">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single-product-wrap">
                        <div class="thumb">
                            <img src="<?php echo e(asset('public/assets/frontend/images/product-1.png')); ?>" alt="img">
                            <div class="btn-area">
                        ...
                        <div class="product-wrap-details">
                            <div class="media">
                                <div class="author">
                                    <img src="<?php echo e(asset('public/assets/frontend/images/author-1.png')); ?>" alt="img">                                    
                                </div>
                                <div class="media-body">
                                    <h6><a href="#">Owner Name</a></h6>
                                    <p><img src="<?php echo e(asset('public/assets/frontend/images/location.png')); ?>" alt="img">New York real estate </p>
                                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-product-wrap">
                        <div class="thumb">
                            <img src="<?php echo e(asset('public/assets/frontend/images/product-2.png')); ?>" alt="img">
                            <div class="btn-area">
                                <a class="btn btn-base btn-sm" href="#">BUY</a>
                                <a class="btn btn-blue btn-sm" href="#">RENT</a>
                            </div>
                        ...
                        <div class="product-wrap-details">
                            <div class="media">
                                <div class="author">
                                    <img src="<?php echo e(asset('public/assets/frontend/images/author-2.png')); ?>" alt="img">                                    
                                </div>
                                <div class="media-body">
                                    <h6><a href="#">Owner Name</a></h6>
                                    <p><img src="<?php echo e(asset('public/assets/frontend/images/location.png')); ?>" alt="img">New York real estate </p>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-product-wrap">
                        <div class="thumb">
                            <img src="<?php echo e(asset('public/assets/frontend/images/product-3.png')); ?>" alt="img">
                            <div class="btn-area">
                                <a class="btn btn-base btn-sm" href="#">BUY</a>
                                <a class="btn btn-blue btn-sm" href="#">RENT</a>
                            </div>
                        ...
                        <div class="product-wrap-details">
                            <div class="media">
                                <div class="author">
                                    <img src="<?php echo e(asset('public/assets/frontend/images/author-3.png')); ?>" alt="img">                                    
                                </div>
                                <div class="media-body">
                                    <h6><a href="#">Owner Name</a></h6>
                                    <p><img src="<?php echo e(asset('public/assets/frontend/images/location.png')); ?>" alt="img">New York real estate </p>
    ...
    <div class="service-area bg-gray py-5">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-6">
                    <div class="single-service-wrap style-2" style="background-image: url(assets/images/service-big-1.png);">
                        <div class="thumb">
                            <img src="assets/images/service-small-1.png" alt="icon">
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-service-wrap style-2" style="background-image: url(assets/images/service-big-2.png">
                        <div class="thumb">
                            <img src="assets/images/service-small-2.png" alt="icon">
                        </div>
                        <div class="single-service-details">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-service-wrap style-2 mb-0" style="background-image: url(assets/images/service-big-3.png);">
                        <div class="thumb">
                            <img src="assets/images/service-small-3.png" alt="icon">
                        </div>
                        <div class="single-service-details">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                <div class="thumb">
                                    <img src="assets/images/project-1.png" alt="img">
                                    <div class="product-wrap-details">
                                        <div class="media">
                                            <div class="author">
                                                <img src="assets/images/author-1.png" alt="img">           
                                            </div>
                                            <div class="media-body">
                                                <h6><a href="#">Owner Name</a></h6>
                                                <p><img src="assets/images/location.png" alt="img">New York real estate </p>
                                            </div>
                                            <a class="fav-btn float-right" href="#"><i class="far fa-heart"></i></a>
                                        </div>
                                    </div> 
                                ...
                                <div class="product-details-inner">
                                    ...
                                    <ul class="meta-inner">
                                        <li><img src="assets/images/location2.png" alt="img">New York</li>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                <div class="thumb">
                                    <img src="assets/images/project-2.png" alt="img">
                                    <div class="product-wrap-details">
                                        <div class="media">
                                            <div class="author">
                                                <img src="assets/images/author-2.png" alt="img">           
                                            </div>
                                            <div class="media-body">
                                                <h6><a href="#">Owner Name</a></h6>
                                                <p><img src="assets/images/location.png" alt="img">New York real estate </p>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                <div class="thumb">
                                    <img src="assets/images/project-3.png" alt="img">
                                    <div class="product-wrap-details">
                                        <div class="media">
                                            <div class="author">
                ...
                <div class="tab-pane fade" id="sell1" role="tabpanel" aria-labelledby="sell1-tab">
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                ...
                                <div class="product-details-inner">
                                    <h4><a href="#">Farm House</a></h4>
                                    <ul class="meta-inner">
                                        <li><img src="<?php echo e(asset('public/assets/frontend/images/location2.png')); ?>" alt="img">New York</li>
                                        <li><a href="#">For Sell</a></li>
                                    </ul>
                                    <p>Lorem ipsum dolor consectetur iicing elit, sed do eius Lorem ipsum dolo amet, costur adipisicing eiusmod.</p>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-product-wrap style-bottom">
                                <div class="thumb">
                                    <img src="<?php echo e(asset('public/assets/frontend/images/project-1.png')); ?>" alt="img">
                                    <div class="product-wrap-details">
                                        <div class="media">
                                            <div class="author">
                                                <img src="<?php echo e(asset('public/assets/frontend/images/author-1.png')); ?>" alt="img">           
    ...
    <div class="testimonial-area pd-top-118 pd-bottom-120 bg-overlay" style="background: url('<?php echo e(asset('public/assets/frontend/images/testimonial-bg.png')); ?>');">
                        ...
                        <div class="testimonial-slider-1 owl-carousel">
                            <div class="item">
                                <div class="single-testimonial-inner pl-lg-5 pr-lg-5 text-center">
                                    <div class="thumb">
                                        <img src="<?php echo e(asset('public/assets/frontend/images/quote.png')); ?>" alt="img">
                                    </div>
                                    <div class="details">
            ...
            <div class="row">
                <div class="col-lg-6 col-sm-6">
                    <div class="single-category-product-wrap style-two text-center">
                        <div class="thumb">
                            <img src="<?php echo e(asset('public/assets/frontend/images/cat-1.png')); ?>" alt="img">
                        </div>
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="single-category-product-wrap style-two text-center">
                        <div class="thumb">
                            <img src="<?php echo e(asset('public/assets/frontend/images/cat-2.png')); ?>" alt="img">
                        </div>
                        <div class="single-category-product-details">
                ...
                <div class="col-lg-6 col-sm-6">
                    <div class="single-category-product-wrap style-two text-center">
                        <div class="thumb">
                            <img src="<?php echo e(asset('public/assets/frontend/images/cat-3.png')); ?>" alt="img">
                        </div>
                        <div class="single-category-product-details">
...
<?php /**PATH D:\xampp\htdocs\anilsir\smartSpaceFinder\resources\views/frontend/home.blade.php ENDPATH**/ ?>