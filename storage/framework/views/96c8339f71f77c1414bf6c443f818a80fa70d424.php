...
<body>
    ...
    <div class="td-search-popup" id="td-search-popup">
        <form action="<?php echo e(route('search-property')); ?>" class="search-form">
                ...
                <div class="row">
                    <div class="col-lg-8 text-lg-left text-center">
                        <ul>
                            ...
                            <li><p><img src="<?php echo e(asset('assets/frontend/images/phone.png')); ?>" alt="img"> <?php echo e($contact_info->phone); ?></p></li>
                            <li><p><img src="<?php echo e(asset('assets/frontend/images/envelope.png')); ?>" alt="img">  <?php echo e($contact_info->email); ?></p></li>
                        </ul>
                    </div>
                    <div class="col-lg-4">
            ...
            <div class="container nav-container">
                ...
                <div class="collapse navbar-collapse" id="dkt_main_menu">
                    <ul class="navbar-nav menu-open text-center">
                            ...
                            <div  class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <?php if(!blank($properyCategory)): ?>
                                    <?php $__currentLoopData = $properyCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <a class="dropdown-item" href="<?php echo e(route('search.category' , ['slug' => Str::slug($category->title) , 'id' => $category->id])); ?>"><?php echo e($category->title); ?></a>
                        ...
                        <li><a target="_blank" href="<?php echo e($front_menus->menu_link); ?>"><?php echo e($front_menus->title); ?> <!--RV Rental --> </a></li>
                        <li><a href="<?php echo e(route('search-property')); ?>?property_type=2">Office Space</a></li>
    ...
    </div><?php /**PATH /homepages/36/d911497826/htdocs/resources/views/frontend/includes/header.blade.php ENDPATH**/ ?>