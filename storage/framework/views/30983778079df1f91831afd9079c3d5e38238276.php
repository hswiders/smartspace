        ...
        <div class="row gutters-sm py-5">
            ...
            <div class="card">
                ...
                <nav class="nav flex-column nav-pills nav-gap-y-1">
                    ...
                    <a href="<?php echo e(route('user.myproperties')); ?>"  class="nav-item nav-link has-icon nav-link-faded">
                    ...
                    <a href="<?php echo e(route('user.fav-properties')); ?>"  class="nav-item nav-link has-icon nav-link-faded">
            ...
            <div class="card">
                ...
                <div class="tab-pane active" id="profile">
                    ...
                    <div class="single-input-inner style-bg-border">
                        ...
                        <form id="handleImageAjax" action="<?php echo e(route('user.do-update-image')); ?>" method="post" enctype="multipart/form-data">
                            
                            <label for="fileToUpload">
                                <div class="profile-pic" style="background-image: url('<?php echo e(asset($user->image)); ?>')">
                ...
                <form method="post" id="handleUpdateAjax" action="<?php echo e(route('user.do-update-profile')); ?>" name="postform">
                    <div class="single-input-inner style-bg-border">
                        <label for="first_name">First Name</label>
                        <input type="text" class="form-control" id="first_name" name="first_name" aria-describedby="first_nameHelp" placeholder="Enter your first name" value="<?php echo e($user->first_name); ?>">
                    ...
                    <div class="single-input-inner style-bg-border">
                        ...
                        <input type="text" class="form-control" id="last_name" name="last_name" aria-describedby="last_nameHelp" placeholder="Enter your last name" value="<?php echo e($user->last_name); ?>">
                    ...
                    <div class="single-input-inner style-bg-border">
                        ...
                        <textarea class="form-control autosize" id="bio" name="bio" placeholder="Write something about you" style="overflow: hidden; overflow-wrap: break-word; resize: none; "><?php echo e($user->bio); ?></textarea>
                    </div>
                    <!-- <div class="single-input-inner style-bg-border">
                    ...
                    <div class="single-input-inner style-bg-border">
                        ...
                        <input type="text" class="form-control" id="address" name="address" placeholder="Enter your location" value="<?php echo e($user->address); ?>">
                    </div>
                    <div class="single-input-inner style-bg-border">
                        <label for="email">Email</label>
                        <input disabled type="email" class="form-control" id="email" placeholder="Enter your Email" value="<?php echo e($user->email); ?>">
                    </div>
                    <div class="single-input-inner style-bg-border">
                         <label for="phone">Phone Number</label>
                         <div class="input-group">
                             <span class="input-group-text" >
                                    <?php echo e($user->phonecode); ?>

                                </span>
                                    <input disabled type="text" class="form-control " id="phone" name="phone" placeholder="Enter your Phone Number" value="<?php echo e($user->phone); ?>">
                ...
                <div class="tab-pane" id="security">
                    ...
                    <hr>
                    <form class="signin-inner" method="post" id="handleChangePasswordAjax" action="<?php echo e(route('user.do-change-password')); ?>" name="postform">
                        <div class="single-input-inner style-bg-border">
...
</script><?php /**PATH /homepages/36/d911497826/htdocs/resources/views/frontend/user/dashboard.blade.php ENDPATH**/ ?>