...
<body>
                    ...
                    <ul class="navbar-nav menu-open text-center">
                        ...
                        <li class="dropdown show">
                            ...
                            <div  class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                <a class="dropdown-item" href="<?php echo e(route('search-property')); ?>">Furnished Full Residence</a>
    ...
    </div><?php /**PATH D:\Hakimuddin\Laravel Sites Local\smartSpaceFinder\resources\views/frontend/includes/header.blade.php ENDPATH**/ ?>