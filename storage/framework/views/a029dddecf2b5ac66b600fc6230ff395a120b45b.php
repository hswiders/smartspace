...
<div class="add-property-area pd-top-120 body-bg">
    <div class="container">
        <?php if($user->property_count != 0): ?>
          ...
          <form class="" method="post" id="handleAjax" action="<?php echo e(route('user.property.store')); ?>" name="postform" style="display:none;">
            <div class="row">
                    ...
                    <div class="col-12">
                        ...
                        <ul class="my_list row">
                            ...
                            <li class="single-select-inner style-bg-border">
                                <label><input type="checkbox" name="animities[]" class="checkbox parent" value="<?php echo e($element->id); ?>"> <b><?php echo e($element->name); ?></b> </label>
                                <ul class="" >
                                <?php $__currentLoopData = $element->childs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="single-select-inner style-bg-border">
                                        <label><input type="checkbox" name="animities[]" class="checkbox" value="<?php echo e($child->id); ?>"> <?php echo e($child->name); ?> </label>
                                    </li>
                    ...
                    <div class="col-12">
                        ...
                        <ul class="my_list">
                            <?php $__empty_1 = true; $__currentLoopData = $parking_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $element): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <li class="single-select-inner style-bg-border">
                                <label><input type="checkbox" name="parking_type[]" class="checkbox" value="<?php echo e($element->id); ?>"> <?php echo e($element->title); ?> </label>
                            </li>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            ...
            <div class="property-form-grid">
                <div class="row">
                    <div class="col-md-6">
                        <label class="single-input-inner style-bg-border">
                            <input type="text" name="name" value="<?php echo e(Auth::user()->first_name.' '.Auth::user()->last_name); ?>" placeholder="Name">
                        </label>
                    </div>
                    <div class="col-md-6">
                        <label class="single-input-inner style-bg-border">
                            <input type="email" name="email" value="<?php echo e(Auth::user()->email); ?>" placeholder="Email">
                        </label>
                    </div>
                    <div class="col-md-6">
                        <label class="single-input-inner style-bg-border">
                            <input type="number" name="phone" value="<?php echo e(Auth::user()->phone); ?>" placeholder="Phone">
                        </label>
                    </div>
...
</script><?php /**PATH /homepages/36/d911497826/htdocs/resources/views/frontend/property/add-property.blade.php ENDPATH**/ ?>