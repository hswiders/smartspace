			...
			<div class="col-xl-12">
				<div class="table-responsive">
					<table id="example3" class="display" style="min-width: 845px">
						...
						<tbody>
							<?php if(!blank($parking_types)): ?>
								<?php $sn = 1; ?>
								<?php $__currentLoopData = $parking_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									<tr>
										<td class="tbl-bx"><?php echo e($sn); ?></td>
										<td><?php echo e($row->title); ?></td>
										
										<td>
                                            <a href="javascript:;" class="btn btn-primary shadow btn-xs sharp me-1" data-bs-toggle="modal" data-bs-target="#updateParkingTypesModal<?php echo e($row->id); ?>"><i class="fas fa-pencil-alt"></i></a>
                                             <a href="javascript:void(0)" onclick="delParkingTypes(<?php echo e($row->id); ?>)" id="delBtn<?php echo e($row->id); ?>" class="btn btn-danger shadow btn-xs sharp me-1"><i class="fa fa-trash"></i></a>

                                        </td>
									</tr>


<div class="modal fade" id="updateParkingTypesModal<?php echo e($row->id); ?>">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form method="post" onsubmit="return updateParkingTypes(event, '<?php echo e($row->id); ?>')" id="updateParkingTypes<?php echo e($row->id); ?>" enctype="multipart/form-data">
            	<?php echo csrf_field(); ?>
                ...
                <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-12">
                                ...
                                <input type="text"  name="title" placeholder="ParkingTypes name.." class="form-control" value="<?php echo e($row->title); ?>" required>
    ...
    ***********************************-->
    <script type="text/javascript">
    	function updateParkingTypes(event,  fid) {
		    ...
		    $.ajax({
		        url: '<?php echo e(url("admin/update-parking-types")); ?>',
		        data: data,
		        processData: false,
		        contentType: false,
		        type: 'POST',
		  ...
		  function addParkingTypes(event) {
		    ...
		    $.ajax({
		        url: '<?php echo e(url("admin/add-parking-types")); ?>',
		        data: data,
		        processData: false,
		        contentType: false,
		        type: 'POST',
		  ...
		  function delParkingTypes(id) {
		    if(confirm('Are you soure want to delete?')){
			    $.ajax({
			        url: '<?php echo e(url("admin/del-parking-types")); ?>',
    ...
    </script><?php /**PATH /homepages/36/d911497826/htdocs/resources/views/admin/parking-types-list.blade.php ENDPATH**/ ?>