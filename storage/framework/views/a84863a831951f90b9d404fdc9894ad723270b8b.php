<footer class="footer-area style-two" style="background: url('<?php echo e(asset('public/assets/frontend/images/footer-banner.jpg')); ?>') no-repeat center/cover;">
    ...
    <script src="<?php echo e(asset('public/assets/frontend/js/vendor.js')); ?>"></script>
    <script src="<?php echo e(asset('public/assets/frontend/js/main.js')); ?>"></script>

</body>
</html><?php /**PATH D:\xampp\htdocs\anilsir\smartSpaceFinder\resources\views/frontend/includes/footer.blade.php ENDPATH**/ ?>