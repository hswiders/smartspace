...
<head>
    ...
    <title>Email | <?php echo e(env('APP_NAME')); ?></title>
                      ...
                      <tr>
                        <td align="center" valign="top" style="border-bottom:2px solid #66A6FF;padding:0px;background:-moz-linear-gradient(top,#fff,#f6f6f6);background:#7C8F97;">
                          <table border="0" cellpadding="0" cellspacing="10" width="100%">
                            <tbody>
                              <tr> 
                                <td align="center" style="text-align: center;" valign="middle"><a style="font-family:\'Ubuntu\',sans-serif;color:#ff3000;font-weight:300;display:block;letter-spacing:-1.5px;text-decoration:none;margin-top:2px" href="<?php echo e(url('')); ?>"><img src="<?php echo e(asset('')); ?>assets/frontend/images/white-logo.png" style="padding-top:0;display:inline-block;vertical-align:middle;margin-right:0px;height:55px" class="CToWUd"></a></td>
                              </tr>
                            </tbody>
                          </table>
                        </td>
                              ...
                              <tr>
                                <td align="left" valign="top" style="color:#444;font-size:14px">
                                  <?php echo $data['body']; ?>
                                   ...
                                   <p style="margin:0;padding:10px 0px">Thank you,<br>Team <?php echo e(env('APP_NAME')); ?></p>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                            ...
                            <tbody>
                              <tr>
                                <td align="left" valign="top" width="80%">
                                  <div style="margin:0;padding:0;color:#fff;font-size:13px"><a href="<?php echo e(url('')); ?>/privacy-policy" style="color:white;text-decoration:none">© Copyright <?php echo e(date('Y').' '.env('APP_NAME')); ?> All Rights Reserved.</div>
                                </td>
...
</html><?php /**PATH /homepages/36/d911497826/htdocs/resources/views/mail.blade.php ENDPATH**/ ?>