    ...
    ***********************************-->
	...
	<script src="<?php echo e(asset('public/assets/vendor/jquery-nice-select/js/jquery.nice-select.min.js')); ?>"></script>
     <script src="<?php echo e(asset('public/assets/vendor/datatables/js/jquery.dataTables.min.js')); ?>"></script>
    <script src="<?php echo e(asset('public/assets/js/plugins-init/datatables.init.js')); ?>"></script>

	<script src="<?php echo e(asset('public/assets/vendor/chart.js/Chart.bundle.min.js')); ?>"></script>
	<script src="<?php echo e(asset('public/assets/vendor/apexchart/apexchart.js')); ?>"></script>
   ...
   <!--  <script src="<?php echo e(asset('public/assets/js/owl.carousel.min.js')); ?>"></script>
    ...
    <script src="<?php echo e(asset('public/assets/js/styleSwitcher.js')); ?>"></script>
    <script src="<?php echo e(asset('public/assets/vendor/lightgallery/js/lightgallery-all.min.js')); ?>"></script>
...
<?php /**PATH D:\xampp\htdocs\anilsir\smartSpaceFinder\resources\views/admin/includes/footer.blade.php ENDPATH**/ ?>