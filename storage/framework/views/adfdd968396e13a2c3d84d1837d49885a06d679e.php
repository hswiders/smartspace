...
<head>
	...
	<link rel="shortcut icon" type="<?php echo e(asset('ddfdf/assets/image/png')); ?>" href="<?php echo e(asset('assets/images/favicon.png')); ?>" />
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="" class="brand-logo" style="background-color: #fff;">
				<img src="<?php echo e(asset('assets/images/logo-full.png')); ?>" alt="" width="100%">
...
<div class="header">
		...
		</div><?php /**PATH D:\Hakimuddin\Laravel Sites Local\smartSpaceFinder\resources\views/admin/includes/header.blade.php ENDPATH**/ ?>